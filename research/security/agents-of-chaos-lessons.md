# Agents of Chaos — Lessons for Calciforge/NZC
...
**Calciforge hook point:** Clash crate policy enforcement could require verification for high-impact actions.
...
**Calciforge hook point:** `auth.rs` `resolve_channel_sender` — map senders to permission tiers.
...
**Calciforge hook point:** Per-sender webhook history (50 turns) partially addresses this — ensure suspicion flags survive.
...
- **Per-sender webhook history** in Calciforge — 50 turns of context per sender
