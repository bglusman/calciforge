...
CALCIFORGE_OPENCLAW_MODEL_GATEWAY_MODEL="${CALCIFORGE_OPENCLAW_MODEL_GATEWAY_MODEL:-qwen3.6:27b}"
...
CALCIFORGE_HELICONE_ORG_NAME="${CALCIFORGE_HELICONE_ORG_NAME:-Calciforge Local}"
CALCIFORGE_HELICONE_DASHBOARD_USER_EMAIL="${CALCIFORGE_HELICONE_DASHBOARD_USER_EMAIL:-}"
...
# Source shared installer primitives before module/domain helpers.
...
# shellcheck source=lib/helicone.sh
source "$(dirname "${BASH_SOURCE[0]}")/lib/helicone.sh"

# shellcheck source=lib/fnox.sh
source "$(dirname "${BASH_SOURCE[0]}")/lib/fnox.sh"
