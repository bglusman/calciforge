...
///
/// Regression guard for the bug found by triage: `substitute_url()`
/// previously always passed `None` for dest_host, so any secret could
/// be exfiltrated by URL-embedding it.
#[tokio::test]
