...
#[allow(dead_code)]
pub trait OneCliBackend: Send + Sync {
...
#[async_trait::async_trait]
impl OneCliBackend for MockBackend {
    async fn chat_completion(
        &self,
        model: String,
        messages: Vec<ChatMessage>,
...
#[async_trait::async_trait]
impl OneCliBackend for EmbeddedBackend {
    async fn chat_completion(
        &self,
        _model: String,
...
#[async_trait::async_trait]
impl OneCliBackend for HttpBackend {
    async fn chat_completion(
        &self,
        model: String,
        messages: Vec<ChatMessage>,
...
#[async_trait::async_trait]
impl OneCliBackend for LibraryBackend {
    async fn chat_completion(
        &self,
        _model: String,
        _messages: Vec<ChatMessage>,
