...
mod tests {
    use super::*;
    use crate::proxy::openai::{ChatMessage, MessageContent, ToolDefinition, FunctionDefinition, ToolChoice, Usage};
    use crate::proxy::traceloop::{TraceloopRouter, ProviderConfig, ProviderType, LatencyStats, CacheEntry};
    ...
    fn test_cache_key_generation() {
        ...
        let key4 = router.generate_cache_key("test-model", &different_messages, &tools, &tool_choice);
        assert_ne!(key1, key4);
    }
