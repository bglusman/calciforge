//! Tool manifest — zeroclawed's own capabilities as OpenAI tool definitions.
//!
//! `GET /v1/tools/manifest` returns a JSON array of tool definitions that any
//! model can inject into its `tools` parameter to call back into zeroclawed.
//!
...
/// Build the tool manifest for this zeroclawed instance.
///
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "audio_url": {
                            "type": "string",
                            "description": "URL of audio file accessible to zeroclawed"
                        },
                        "language": {
                            "type": "string",
