//! Voice pipeline surface for zeroclawed.
//!
//! Zeroclawed does not own a voice pipeline. It provides three thin integration
...
//!    Returns zeroclawed's own capabilities as OpenAI-compatible tool definitions
//!    so any model can call into zeroclawed (switch model, list models, etc.)
